...
function saveMeal(e) {
    if (e.target.classList.contains('save-btn')) {
        ...
        const savedMeal = {
            ...
            image: mealImage,
            id: mealId // Include meal ID in saved meal
        };
...
// Function to display a saved meal in the saved meals list
...
// Function to handle actions on saved meals (Remove or Get Recipe)
...
// Function to get recipe for saved meal
...
// Function to create a modal and insert recipe details
function mealRecipeModal(meal) {
    ...
    // Attach event listener to the "Save Meal" button after it's created
